...
<body id="jobs-about">
    ...
    <div class="jobs-buttons">
        <a href="apply.php" class="link" id="REF-PT1" onclick="saveLinkValue('REF-PT1')">Apply</a>
    </div>
    </div>
    ...
    <section class="S2">
        ...
        <div class="jobs-buttons">
            <a href="apply.php" class="link" id="REF-UID" onclick="saveLinkValue('REF-UID')">Apply</a>
        </div>
        </div>
